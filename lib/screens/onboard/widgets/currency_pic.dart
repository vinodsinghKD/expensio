        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              BounceInDown(child: const Icon(Icons.currency_exchange, size: 40)),
              const SizedBox(height: 15),
              FadeIn(
                child: Text(
                  "Select Currency",
                  style: theme.textTheme.headlineMedium!.apply(color: theme.colorScheme.primary, fontWeightDelta: 1),
                ),
              ),
          ...
          onPressed: () {
            if (_currency == null) {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text("Please select currency")),
              );
            } else {

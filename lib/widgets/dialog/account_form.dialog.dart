...
import 'package:expensio/data/icons.dart';
  ...
  void initState() {
    ...
    if (widget.account != null) {
      _account = Account(
        ...
        iconName: widget.account!.iconName,
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Icon(
                    AppIcons.icons[_account!.iconName] ?? Icons.help_outline,
                    color: Colors.white,
                  ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, index) => Container(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      setState(() {
                        _account!.iconName = _account!.iconName = AppIcons.icons.entries
                            .firstWhere((entry) => entry.value == AppIcons.icons[index])
                            .key;
                      });
                    },
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(40),
                        border: Border.all(
                          color: _account!.iconName == AppIcons.iconNames[index]
